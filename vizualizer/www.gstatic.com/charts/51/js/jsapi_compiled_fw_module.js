...
gvjs_WL.prototype.Hl = gvjs_V(74, function() {
    if (null == this.yn) {
        ...
        if (!a) throw Error("No draw routine for " + this.pf + ".");
...
gvjs_DL.prototype.cp = gvjs_V(72, function() {
    if (null != this.Ot) return this.Ot;
...
gvjs_aR.prototype.Ac = function(a) {
    gvjs_Dl(a);
    var b = a.$();
    if (2 > b) throw Error(gvjs_gs);
    for (var c = !0, d = [], e = 0; e < b; e++) {
        var f = a.Jg(e);
        gvjs_jf(f) && (c ? (f = gvjs_mu, c = !1) : f = gvjs_$t);
        d.push(f)
    }
    if (d[0] !== gvjs_mu) throw Error("Invalid data format: first column must be domain.");
    a = gvjs_Eia(d);
    return {
        Nf: a.Nf,
...
function gvjs_Eia(a) {
    for (var b = [gvjs_mu, gvjs_$t], c = {
        ...
        if (0 <= h && h < e) {
            ...
            d.push(k);
            h.groups.push(k)
        } else 0 <= e && g === b[e] ? (d.pop(), h = d[d.length - 1], d.push(k), h.groups.push(k)) : e + 1 < b.length && g === b[e + 1] ? (h = d[d.length - 1], e++, d.push(k), h.groups.push(k)) : (k = d[d.length - 1], g in k.Nf || (k.Nf[g] = []), k.Nf[g].push(f))
    }
    return c
}
var gvjs_Fia = {
...
function gvjs_bR(a) {
    return function(b, c) {
        ...
        if (b.yr) throw Error("can't stage a shape that's already staged.");
        if (-1 !== a.ur.indexOf(b)) throw Error("can't stage a shape that's already drawn.");
        b.yr = !0;
        a.ur.push(b);
...
function gvjs_lR(a, b, c, d) {
    ...
    if (0 <= e) {
        if (null != a.elements[e] || !b.yr) throw "Shape exists and is not a staged shape.";
        b.yr = !1;
        a.elements[e] = c
    } else a.ur.push(b), a.elements.push(c);
    c = b.Rk();
...
gvjs_.lv = function(a) {
    return gvjs_mR(this, a) || a.getContext() ? (a.fireEvent(gvjs_Rp, [a]), a) : this.xda(a, !0)
};
...
gvjs_.CS = function(a) {
    if (null == a.getContext()) throw "Attempted to remove shape that doesn't have a context.";
...
gvjs_.T1 = function(a) {
    ...
    if (a.zP) {
        b = a.Vg;
        for (var c = 0, d = b.length; c < d; c++) a.fireEvent(gvjs_XQ, [b[c]]);
        b = this.ur.indexOf(a)
    }
...
gvjs_.Q1 = function(a) {
    for (var b = a.target; null != b.getAttribute(gvjs_Pp);) b = b.parentNode;
...
gvjs_.gua = function(a) {
    if ("Path" !== a.Rk()) {
        ...
        a.yr && (b.style.display = gvjs_f, c.parentNode.removeChild(c))
    }
};
gvjs_.xua = function(a, b) {
    ...
    a.dCa = !0;
    if (null != this.Zn) this.Zn.push(b);
    else {
        this.Zn = [b];
        var c = this.$V.xha(gvjs_s(function(d) {
            this.Zn = this.Zn.filter(function(e) {
                ...
                if (d >= e.end || e.animation.MG()) return e.shape.style(e.animation.lva, e.animation.iya), e.animation.fireEvent(gvjs_up, [e.shape, e.animation]), !1;
...
gvjs_.clear = function() {
    ...
    gvjs_iR(this.XT);
    this.filters = {};
    for (this.XT = {}; b.firstChild;) b.firstChild.tagName === gvjs_hp && (c = !0), b.removeChild(b.firstChild);
...
gvjs_.update = function(a) {
    var b = this;
    gvjs_fz(this.dimensions, a) || (this.dimensions = a.clone(), this.km = null, this.cp && this.cp.clear(), a = new gvjs_kR(this.container, a.width || 0, a.height || 0), gvjs_cR(a, this.kI ? {
        fonts: this.kI
...
function gvjs_uR(a, b, c, d) {
    ...
    for (var e in a)
        if (a.hasOwnProperty(e))
            if (a[e] instanceof Object && !(a[e] instanceof Array)) gvjs_uR(a[e], b.concat(e), c, d);
            else {
...
function gvjs_zR(a, b) {
    gvjs_wq.call(this, b);
    this.Vg = [];
    if (a) throw "prepopulating a group is unimplemented.";
...
gvjs_.lv = function(a) {
    if (a.getContext()) throw "cannot add a shape to a group that already has a context.";
    this.Vg.push(a);
    a.o(gvjs_Rp, this.Yz);
    a.o(gvjs_Wt, this.hm);
    a.o(gvjs_jd, this.hm);
...
gvjs_.clear = function() {
    for (var a = 0, b = this.Vg.length; a < b; a++) this.Vg[a].Ab(gvjs_Rp, this.Yz), this.fireEvent(gvjs_XQ, [this.Vg[a]]);
    this.Vg = [];
...
gvjs_.CS = function(a) {
    if (0 > this.Vg.indexOf(a)) throw gvjs_MQ;
...
function gvjs_CR(a, b, c, d) {
    c = d.target;
    (c = c.data() && c.data().idStr) && c != gvjs_Bs && (c = gvjs_LL(c), a.pi(c, b))
}
gvjs_.Oa = function() {
    return this.re
};
...
gvjs_JR.prototype.QG = function(a, b, c) {
    if (b == gvjs_9u) {
        if (!a.equals(c.ff)) return c.ff = a, !0
    } else if (null != c.ff) return c.ff = null, !0;
    return !1
};
...
gvjs_KR.prototype.Dk = function(a) {
    ...
    return gvjs_v(a, function(b) {
        var c = b.row;
        b = b.column;
        if (null != c && null != b) c = gvjs_wR(b, c);
        else if (null != c) c = gvjs_JL(c);
        else if (null != b) c = gvjs_xR(b);
        else throw Error("Invalid selection. No row or column");
...
gvjs_LR.prototype.QG = function(a, b, c) {
    a = a.ie();
    c.Cn.has(a) ? c.Cn.delete(a) : (this.kxa && c.Cn.clear(), c.Cn.add(a));
    return !0
};
gvjs_LR.prototype.Dk = function(a) {
    var b = [];
    a = gvjs_8d(a.Cn);
    for (var c = a.next(); !c.done; c = a.next()) b.push(new gvjs_yR(gvjs_k, gvjs_LL(c.value)));
    return b
};
...
gvjs_MR.prototype.QG = function(a, b, c) {
    if (b == gvjs_9u) {
        if (!a.equals(c.Rn)) return c.Rn = a, !0
    } else if (null != c.Rn) return c.Rn = null, !0;
    return !1
};
...
gvjs_OR.prototype.Kea = function(a, b, c) {
    var d = c.featureId.ie(),
        e = b.get(d, null);
    e && e.A4 && a.Re(e.A4);
    "_" === c.layer[0] ? (gvjs_6(e.Hl, !1), e.A4 = c.Hl, e.yxa = c.layer, a.$n(e.A4, e.featureId, e.yxa)) : e != c && (null === e || e.layer !== c.layer ? (null != e && a.Re(e.Hl), a.$n(c.Hl, c.featureId, c.layer)) : a.we(c.Hl, e.Hl, c.featureId, c.layer), b.set(d, c))
};
...
gvjs_.fi = function(a) {
    return null != a && (a -= .5, 0 <= a && a < this.pK.length) ? this.pK[a] : null
};
gvjs_.add = function(a, b) {
    var c = null;
    a = String(a);
    a in this.yi && b || (this.yi[a] = c = this.pK.length, this.pK.push(a));
    return c + .5
};
...
gvjs_ZR.prototype.Cq = function(a, b) {
    ...
    if (2 > this.lu.Cd() || null == b) return a;
    a = gvjs_vj(a);
    b = this.lu.get(b);
...
gvjs_0R.prototype.La = function(a) {
    for (var b = this.label.split("\n"), c = 0, d = 0, e = b.length; d < e; d++) c = Math.max(c, a(b[d], this.ja));
    return c
};
var gvjs_1R = {
        Dia: gvjs_$c,
        ...
        if (!(this.Ua.start > m || this.Ua.end < m)) {
            ...
            switch (k) {
                case gvjs_0:
                    ...
                    break;
                case gvjs_R:
                    q.left -= r.width, q.right -= r.width
            }
            switch (e) {
                case gvjs_0:
                    r = r.height / 2;
                    ...
                    break;
                case gvjs_R:
                    q.top -= r.height, q.bottom -= r.height
            }
            f && 8 > q.left - f.right || (f = q, gvjs_5x(d, q), k = (new gvjs_1Q(m, b.top, n, p)).style(gvjs_Dp, k === gvjs_R ? 1 : k === gvjs_0 ? .5 : 0).style(gvjs_eq, e === gvjs_R ? 1 : e === gvjs_0 ? .5 : 0), l = gvjs_KL(this.BG.clone(), gvjs_5a, l), c.push(new gvjs_NR(k, l, this.Ci)))
        }
    }, this);
    if (this.Qb) {
        var g = this.Qb,
            h = a.me(g, this.Oe);
        e === gvjs_2 ? (g = (new gvjs_1Q((d.right -
            d.left) / 2 + d.left, d.bottom + 18, g, this.Oe)).style(gvjs_Dp, .5).style(gvjs_eq, 0), d.bottom += h.height + 18) : (g = (new gvjs_1Q((d.right - d.left) / 2 + d.left, d.top - 18, g, this.Oe)).style(gvjs_Dp, .5).style(gvjs_eq, 1), d.top -= h.height + 18);
...
function gvjs_Jia(a) {
    ...
    if (a.Gra) {
        for (; b[0].value < a.Gc;) b.shift();
        b[0].value != a.Gc && (d = a.Zs(a.Gc), null != d && b.unshift({
            value: a.Gc,
            label: d
        }));
        for (; b[b.length - 1].value > a.xe;) b.pop();
        b[b.length - 1].value != a.xe && (d = a.Zs(a.xe), null != d && b.push({
            value: a.xe,
            label: d
        }))
    }
...
gvjs_5R.prototype.R = function(a, b) {
    ...
    if (this.Qb) {
        ...
        if (e === gvjs_2) {
            var h =
                (new gvjs_1Q(d.right + 18, (d.bottom - d.top) / 2 + d.top, f, this.Oe)).style(gvjs_Sp, 90).style(gvjs_Dp, .5).style(gvjs_eq, 1);
            d.right += g.height + 18
        } else e === gvjs_R && (h = (new gvjs_1Q(d.left - 18, (d.bottom - d.top) / 2 + d.top, f, this.Oe)).style(gvjs_Sp, -90).style(gvjs_Dp, .5).style(gvjs_eq, 1), d.left -= g.height + 18);
...
gvjs_9R.prototype.R = function(a, b) {
    ...
    this.PK && gvjs_u(this.fg.ticks, function(f, g) {
        ...
        if (!(0 > f || 1 < f)) {
            var h = this.zI;
            f === this.qe.Fo() && (h = this.CG, d = !0);
            f = this.RK(b, f, h);
            null != f && (g = gvjs_KL(this.AG.clone(), gvjs_KQ, g), c.push(new gvjs_NR(f, g, this.Ci)))
        }
    }, this);
    if (!d && this.W2 && (a = this.qe.Fo(), 0 <= a && 1 >= a && (a = this.RK(b, a, this.CG), null != a))) {
...
gvjs_.property = function(a, b) {
    return null != b ? (this.jE[a] = b, this) : this.jE[a]
};
...
gvjs_.setStyle = function(a, b) {
    if ("padding" === a || a === gvjs_Ev) return this.setStyle(a + ".left", b).setStyle(a + ".right", b).setStyle(a + ".top", b).setStyle(a + ".bottom", b);
    this.md[a] = b;
    return this
};

function gvjs_cS(a, b) {
    for (var c in b) a.setStyle(c, b[c]);
    return a
}
gvjs_.layout = function(a, b, c) {
    ...
    var f = gvjs_rR(gvjs_qR((new gvjs_pR).au(this.getStyle("border.left", 0)), this.getStyle("border.right", 0)), this.getStyle("border.bottom",
            0)).Kn(this.getStyle("border.top", 0)),
    ...
    b = (f = d.oC) ? f.width : 0;
    f = f ? f.height : 0;
    c && (d.La() > c.width && d.Ug(c.width), d.getHeight() > c.height && d.fl(c.height));
    d.oC = new gvjs_A(b, f);
...
function gvjs_eS(a, b, c, d, e) {
    ...
    for (var k = gvjs_Te(0, h), l = gvjs_Te(0, a.wf.height), m = [], n = {}, p = 0; p < a.OB.length; p++)
        if (n[p]) m.push(void 0);
        else {
            var q = p % h,
                r = (p - q) / h,
                t = a.OB[p] || new gvjs_bS,
                u = t.getStyle("colspan");
            if (typeof u !== gvjs_g || 1 > u) u = 1;
            var v = t.getStyle("rowspan");
            if (typeof v !== gvjs_g || 1 > v) v = 1;
            var w = void 0;
            if (c && (!f || !g)) {
                var x = f ? Infinity : 0,
                    y = g ? Infinity : 0;
                ...
                for (var z = q + u; w < z; w++) {
                    x += c.Ic[w];
                    for (var A = r, B = r + v; A < B; A++) n[A * a.wf.width +
                        w] = !0, y += c.Ec[A]
                }
                w = new gvjs_A(x, y)
            }
            ...
            if (!w && (Infinity == x || Infinity == y)) {
                if (Infinity == x)
                    for (w = q, z = q + u; w < z; w++) e[w] = !0;
                if (Infinity == y)
                    for (A = r, B = r + v; A < B; A++) d[A] = !0
            }
            m.push(D);
            1 >= u && (k[q] = Math.max(D.width(), k[q]));
            if (c && !f)
                for (w = q, z = q + u; w < z; w++) isFinite(c.Ic[w]) && (k[w] = Math.max(k[w], c.Ic[w]));
            1 >= v && (l[r] = Math.max(D.height(), l[r]));
            if (c && !g)
                for (A = r, B = r + v; A < B; A++) isFinite(c.Ec[A]) && (l[A] = Math.max(l[A], c.Ec[A]))
        }
    a = gvjs_az.apply(null, k);
    b = gvjs_az.apply(null,
        l);
    return {
        cells: m,
        SO: e,
...
function gvjs_fS(a, b, c) {
    for (var d = 0, e = gvjs_v(b.Ic, function(v, w) {
            ...
            for (var x = Infinity, y = 0, z = this.wf.height; y < z; y++) {
                var A = b.cells[y * this.wf.width + w],
                    B = this.si(w, y);
                A && B && (B = B.getStyle("colspan"), typeof B === gvjs_g && 1 < B || (x = Math.min(x, v - A.width() + A.extra().width)))
            }
        ...
        for (var k = 0, l = a.wf.height; k < l; k++) {
            ...
            if (n = a.si(g, k)) {
                ...
                if (1 < n) {
                    ...
                    f.push(p);
                    m = g;
                    for (n = g + n; m < n; m++) b.SO[m] ? p.columns.xo.push(m) : p.columns.lA.push(m)
                }
            }
        }
    g = 0;
    for (h = f.length; g < h; g++) {
        ...
        if (r < n.width())
            if (0 < p.columns.xo.length) q = Math.max(0, n.width() - r), gvjs_u(p.columns.xo, function(v) {
                var w = b.Ic[v];
    ...
    if (null != c) {
        if (b.size.width < c) {
            if (a = c - b.size.width, 0 < d) {
                for (var u in b.SO) b.Ic[Number(u)] += a / d;
                b.size.width =
                    c
            }
        } else if (b.size.width > c)
            if (1 === b.Ic.length) b.size.width = b.Ic[0] = c;
            else
                for (u = gvjs_Ky(b.Ic.length), gvjs_Qe(u, function(v, w) {
                        return -gvjs_Re(b.Ic[v], b.Ic[w])
                    }), g = 0, h = u.length - 1; g < h; g++)
                    if (a = b.Ic[u[g]], f = b.Ic[u[g + 1]], a !== f) {
                        f = a * (g + 1) - f;
                        k = b.size.width - c;
                        a = f;
                        f >= k && (a = k);
                        f = 0;
                        for (k = g; f <= k; f++) b.Ic[u[f]] -= a / (g + 1);
                        b.size.width -= a;
                        if (b.size.width <= c) break
                    }
        if (b.size.width !== c) {
            g = 0;
            for (h = b.Ic.length; g < h; g++) b.Ic[g] = 0 >= b.size.width ? c / b.Ic.length : b.Ic[g] / b.size.width * c;
            b.size.width = c
        }
    }
}
...
function gvjs_gS(a, b, c) {
    for (var d = 0, e = gvjs_v(b.Ec, function(v, w) {
            ...
            for (var x = Infinity, y = 0, z = this.wf.width; y < z; y++) {
                var A = b.cells[w * this.wf.width + y],
                    B = this.si(y, w);
                A && B && (B = B.getStyle("rowspan"), typeof B === gvjs_g && 1 < B || (x = Math.min(x, v - A.height() + A.extra().height)))
            }
            return Infinity > x ? x : 0
        ...
        for (var k = 0, l = a.wf.width; k < l; k++) {
            ...
            if (n = a.si(k, g)) {
                ...
                if (1 < n) {
                    ...
                    f.push(p);
                    m = g;
                    for (n = g + n; m < n; m++) b.RO[m] ? p.rows.xo.push(m) : p.rows.lA.push(m)
                }
            }
        }
    g = 0;
    for (h = f.length; g < h; g++) {
        ...
        if (r < n.height())
            if (0 < p.rows.xo.length) q = Math.max(0, n.height() - r), gvjs_u(p.rows.xo, function(v) {
                var w = b.Ec[v];
                ...
                q =
                    Math.max(0, Math.min(q, r - n.height() + n.extra().height));
                var t = n.height() - q;
                gvjs_u(p.rows.lA, function(v) {
                    var w = b.Ec[v];
                    b.Ec[v] = b.Ec[v] / r * t;
    ...
    if (null != c) {
        if (b.size.height < c) {
            if (a = c - b.size.height, 0 < d) {
                for (var u in b.RO) b.Ec[Number(u)] += a / d;
                b.size.height =
                    c
            }
        } else if (b.size.height > c)
            if (1 === b.Ec.length) b.size.height = b.Ec[0] = c;
            else
                for (u = gvjs_Ky(b.Ec.length), gvjs_Qe(u, function(v, w) {
                        return -gvjs_Re(b.Ec[v], b.Ec[w])
                    }), g = 0, h = u.length - 1; g < h; g++)
                    if (a = b.Ec[u[g]], f = b.Ec[u[g + 1]], a !== f) {
                        f = a * (g + 1) - f;
                        k = b.size.height - c;
                        a = f;
                        f >= k && (a = k);
                        f = 0;
                        for (k = g; f <= k; f++) b.Ec[u[f]] -= a / (g + 1);
                        b.size.height -= a;
                        if (b.size.height <= c) break
                    }
        if (b.size.height !== c) {
            g = 0;
            for (h = b.Ec.length; g < h; g++) b.Ec[g] = 0 >= b.size.height ? c / b.Ec.length : b.Ec[g] / b.size.height * c;
            b.size.height = c
        }
    }
}
...
gvjs_hS.prototype.p0 = function(a, b, c) {
    var d = this.md,
        e = this.getContent();
    if (null === e) return b.Ug(0), b.fl(0), b;
    var f = b.La();
    f = (null == f ? Infinity : f) - c.al.width();
    var g = d[gvjs_VQ];
    null == g && (g = Infinity);
    0 >= g ? e = [] : (e = gvjs_CG(a, e, d, f, g), e = gvjs_v(e.lines, gvjs_kf));
    e = e.join("\n");
    a = a(e, d);
...
gvjs_iS.prototype.define = function(a, b) {
    var c = 20;
    if (1 < b.length) b = gvjs_Kia(b);
    else {
        b = b[0];
        b.title || (c = 7);
        var d = new gvjs_dS(1, 2),
            e = gvjs_jS(b);
        e && (e.setStyle(gvjs_UQ, b.subtitle ? 15 : 5), d.Wb(0, 0, e));
...
gvjs_mS.prototype.position = function(a, b) {
    if (null == a) {
        ...
        a = [];
        for (var d = 0, e = gvjs_nS.length; d < e; d++) a.push(c), c = gvjs_Be(gvjs_nS, c), c = gvjs_nS[(c + 1) % gvjs_nS.length]
    }
    d = 0;
    for (e = a.length; d < e; d++)
        if (c = a[d], !b && d === e - 1 || gvjs_Ria(this, c)) return gvjs_oS(this, c);
...
function gvjs_Ria(a, b) {
    switch (b) {
        ...
        case gvjs_0:
            return b = new gvjs_5(a.Wd.left - (a.jj.width / 2 - a.Wd.width / 2), a.Wd.top - (a.jj.height / 2 - a.Wd.height / 2), a.jj.width, a.jj.height), b.left >= a.Km.left && b.top >= a.Km.top && b.left + b.width <= a.Km.left + a.Km.width && b.top +
                b.height <= a.Km.top + a.Km.height
    }
}
...
gvjs_rS.prototype.Ava = function(a, b) {
    ...
    c = 0;
    for (var h = d.length; c < h; c++) gvjs_Me(e, this.R(d[c], new gvjs_z(b.x + a.left() + g.left() + f.left(), b.y + a.top() + g.top() + f.top())));
    return e
};
gvjs_rS.prototype.R = function(a, b) {
    b = b || new gvjs_z(0, 0);
    for (var c = [], d = 0, e = this.Kv.length; d < e; d++) {
        var f = (0, this.Kv[d])(a, b);
        if (null !== f) {
            gvjs_Me(c, f);
            break
        }
    }
    this.debug && (e = a.pw, d = e.margin, e = e.padding, gvjs_Me(c, [new gvjs_4Q(b.x + a.left(), b.y + a.top(), a.width(), a.height(), {
        strokeColor: "red",
        fillColor: gvjs_f
    }), new gvjs_4Q(b.x + a.left() + d.left(), b.y + a.top() + d.top(), a.width() - d.width(), a.height() - d.height(), {
        strokeColor: "green",
        fillColor: gvjs_f
    }), new gvjs_4Q(b.x + a.left() + d.left() + e.left(), b.y + a.top() + d.top() +
        e.top(), a.width() - d.width() - e.width(), a.height() - d.height() - e.height(), {
            strokeColor: "blue",
            fillColor: gvjs_f
        })]));
    return c
...
gvjs_sS.prototype.define = function(a) {
    ...
    gvjs_u(a, function(c, d) {
        ...
        if (null != c.title || e) {
            ...
            g ? (c = (new gvjs_dS(1, 2)).Wb(0, 0, f), c.Wb(1, 0, g), b.Wb(1,
                d, c)) : b.Wb(1, d, f)
        }
...
gvjs_tS.prototype.transform = function(a) {
    ...
    if (a instanceof gvjs_Uq) return gvjs_Tia(this, a);
    if (a instanceof gvjs_2Q) return d = gvjs_xq(a), c = a.md, (new gvjs_2Q(gvjs_L(d, "r"), this.window.x.scale(gvjs_L(d, this.Ao ? "y" : "x")), this.window.y.scale(gvjs_L(d, this.Ao ? "x" : "y")), c)).setData(a.data());
...
gvjs_uS.prototype.Zs = function(a) {
    ...
    switch (this.PC) {
        ...
        case Dygraph.THIRTY_MINUTELY:
            c = ":mm";
            0 === a.getMinutes() || this.fs ? (b = !0, c = 7) : b = !1;
            this.fs = !1;
            break;
        case Dygraph.HOURLY:
        ...
        case Dygraph.TWO_DAILY:
            c = "E";
            0 === a.getDay() || this.fs ? (c += "\n" + gvjs_2i.MONTH_DAY_SHORT, b = !0) : b = !1;
            this.fs = !1;
            break;
        case Dygraph.WEEKLY:
    ...
    if (null != c) return c = (new gvjs_Xi(c)).format(a), {
        label: c,
        ja: {
            bold: b
        }
...
gvjs_zS.prototype.transform = function(a) {
    ...
    gvjs_u(a, function(e) {
        if (e instanceof gvjs_4Q) {
            ...
            var h = 0 < f ? b : c,
                k = h[g],
                l;
            if (l = k) l = k.data().id.rb.OBJECT_INDEX;
            !k || Math.abs(f) > Math.abs(l) ? (k && d.push(k), h[g] = e) : d.push(e)
        } else d.push(e)
    });
    gvjs_w(b, function(e) {
    ...
    gvjs_w(c, function(e) {
        d.push(e.clone().data(e.data()).style(gvjs_bp,
            2).style(gvjs_cp, 2).style(gvjs_dp, 2).style(gvjs_ep, 2))
    });
    return d
};
...
gvjs_BS.prototype.transform = function(a) {
    if (a instanceof gvjs_4Q) {
        ...
        g = gvjs_L(d, "y");
        d = gvjs_L(d, gvjs_4c);
        Math.abs(d) > c && (c = gvjs_$y(d), d -= c * b, g += c * b / 2);
        b = a.data();
        null == b && (b = null);
...
function gvjs_ES(a, b) {
    if (a) return gvjs_SR;
    if (b in gvjs_XR) return gvjs_XR[b];
...
function gvjs_Uia(a, b, c, d) {
    ...
    b.Sm.forEach(function(n, p) {
        ...
        q = gvjs_ES(q, n);
        var r = null;
        q.nia && (n = "_discrete", n in f && (r = e[f[n][0]]));
    ...
    e.forEach(function(n, p) {
        ...
        if (!(n in l)) {
            var q = k ? "y" : "x",
                r = c.pb(gvjs_QQ);
            q = c.view(["axes.domain." + n, "axes." + q + "." + n, "axes.domain.all", "axes." +
                q + ".all", "axes.all"
            ]);
            var t = q.view(gvjs_Jd),
                ...
                x = q.fa(gvjs_Xo),
                y = !1;
            null != x && (y = !0, typeof x === gvjs_g ? w.Pw(x) : w.Zt(x));
            x = q.pb(gvjs_Fu);
...
function gvjs_Via(a, b, c, d) {
    ...
    gvjs_u(b.Sm, function(n) {
        ...
        n.C.forEach(function(q, r) {
            ...
            null == r && (q in f ? r = f[q][0] : (f[q] = [], r = h++), f[q].push(r));
            p.push(r);
    ...
    e.forEach(function(n, p) {
        gvjs_u(n, function(q, r) {
            ...
            if (!(q in l)) {
                var t = k ? "x" : "y",
                    u = c.pb([gvjs_QQ]);
                t = c.view(["axes.target." + q, "axes." +
                    t + "." + q, "axes.target.all", "axes." + t + ".all", "axes.all"
                ]);
                var v = t.view(gvjs_Jd),
                    ...
                    y = t.fa(gvjs_Xo),
                    z = !1;
                null != y && (z = !0, typeof y === gvjs_g ? x.Pw(y) : x.Zt(y));
                y = a.W(r);
                var A = t.pb(gvjs_Fu);
...
gvjs_DS.prototype.$g = function() {
    ...
    for (var g in f) {
        var h = f[g];
        null == h.range ? h.range = new gvjs_O(0, 1) : h.range.start === h.range.end && (--h.range.start, h.range.end += 1)
    }
    for (var k in b) h = b[k], null ==
        h.range ? h.range = new gvjs_O(0, 1) : h.range.start === h.range.end && (--h.range.start, h.range.end += 1);
    return {
        table: a,
...
function gvjs_HS(a, b, c) {
    a = gvjs_vj(a);
    "hsl" === c ? (c = gvjs_7Q(a[0], a[1], a[2]), c[2] = Math.max(c[2] - b, 0), a = gvjs__z(c[0], c[1], c[2])) : a = gvjs_1z(a, b);
    return gvjs_uj(a)
}

function gvjs_IS(a, b, c) {
    a = gvjs_vj(a);
    "hsl" === c ? (c = gvjs_7Q(a[0], a[1], a[2]), c[2] = Math.min(c[2] + b, 1), a = gvjs__z(c[0], c[1], c[2])) : a = gvjs_2z(a, b);
    return gvjs_uj(a)
}
...
gvjs_.cache = function(a, b, c) {
    ...
    a.dirty && (a.dirty = !1, Date.now(), a.value = c ? b.call(c) : b());
    return a.value
};
...
function gvjs_NS(a, b, c) {
    ...
    } else d === gvjs_IQ && (d = gvjs_MS(c), c = d.ie(), d = gvjs_xR(d.rb.COLUMN_INDEX).ie(), e = 0 < a.hp.size, f = a.Rv.has(c) || a.Rv.has(d), a.hp.has(c) || a.hp.has(d) ? a.Hfa(b) : f ? a.Cfa(b) : e ? a.Afa(b) : a.Ffa(b))
}
        ...
        e.forEach(function(t) {
            try {
                var u =
                    q.has(t),
                    v = p.has(t);
                if (m && u) r.style(t, k[t]);
                else if (l && v) r.style(t, h[t]);
                else if (u || v) n.has(t) ? r.style(t, g[t]) : r.style(t, null)
            } catch (w) {}
        })
    }, a)
}
...
function gvjs_RS(a, b, c, d) {
    ...
    gvjs_w(gvjs_KS(a), function(k) {
        var l = k.name,
            m = k.margin,
            n = k.ticks;
        n && n.size == f.right - f.left || (n = gvjs_JS(this, l, l).Qv, n = null != n ? gvjs_PS(n, f.right - f.left, gvjs_Oj(n.options, gvjs__Q)) : void 0, n = k.ticks = n);
        if (n) {
            gvjs_5Q(k.range, n.Gc);
            gvjs_5Q(k.range, n.xe);
            gvjs_SS(k);
            if (k.sk == gvjs_vx && 0 < g || k.sk == gvjs_vt && 0 < h) m = 12;
            n = new gvjs_VR({
                start: k.range.start,
                end: k.range.end
            });
            ...
            if (null == p) throw Error('Could not construct axis renderer for horizontal axis named "' + l + gvjs_GQ);
...
function gvjs_TS(a, b, c, d) {
    ...
    gvjs_w(gvjs_LS(a), function(l) {
        var m = l.name,
            n = l.ticks,
            p = l.margin;
        n && n.size == g.bottom - g.top || (n = gvjs_JS(this, m, m).vertical, n = null != n ? gvjs_PS(n, c.bottom - c.top, gvjs_Oj(n.options, gvjs__Q)) : void 0, n = l.ticks = n);
        if (n) {
            gvjs_5Q(l.range, n.Gc);
            gvjs_5Q(l.range, n.xe);
            gvjs_SS(l);
            if (l.sk == gvjs_$c && 0 < h || l.sk == gvjs_j && 0 < k) p = 12;
            n = new gvjs_VR({
            ...
            if (null == q) throw Error('Could not construct axis renderer for vertical axis named "' + m + gvjs_GQ);
...
function gvjs_Yia(a, b, c, d) {
    ...
    for (var f = null, g = 10, h = null, k = null, l = gvjs_oz(c), m = gvjs_US(l), n = 0, p = 0; !gvjs_nz(m, f) && 0 < --g;) f = m, n++, p++, h = gvjs_RS(a, b, l, d), e(h.box), k = gvjs_TS(a, b, l, d), e(k.box), m = gvjs_US(l);
    return {
        rect: m,
...
function gvjs_SS(a) {
    ...
    null != b && (b = (c = typeof b === gvjs_g) ? b : a.scale.scale(b), !c && a.scale.isDiscrete() && (b += .5), null != b && isFinite(b) && (a.range.end = b));
    a.range.start > a.range.end && (c = a.range.start, a.range.start = a.range.end, a.range.end = c)
}

function gvjs_Zia(a) {
    if (gvjs_J(a.definition.options, gvjs_uv) == gvjs_f) return null;
    var b = new gvjs_sS({
            maxWidth: null,
            style: {
    ...
    return b.define(gvjs_De(d.map(function(e,
        f) {
        e = c[e.index];
...
gvjs_.AB = function(a) {
    ...
    var c = this.Tb(),
        d = this.cache("chart-layout", function() {
            ...
            var g = gvjs_cS(gvjs_cS(new gvjs_dS(1, 5), this.definition.style.background), {
                ...
                k = this.definition.subtitle ?
                gvjs_cS(new gvjs_hS(this.definition.subtitle), this.definition.style.subtitle).setStyle(gvjs_5c, gvjs_KL(new gvjs_IL(gvjs_fx), gvjs_rs, gvjs_ZQ).ie()).setStyle("layer", gvjs_Wo) : null;
            h && g.Wb(0, 0, h);
            k && g.Wb(0, 2, k);
    ...
    gvjs_Me(a, this.cache("chart-chrome", function() {
        var f = this,
            ...
            n = new gvjs_rS([function(v, w) {
                ...
                return x.getStyle(gvjs_Sd) === gvjs_rv ? (h = v, k = w, []) : null
            }]);
        n.debug = !1;
        var p = n.R(d);
        this.definition.O = m;
        ...
        gvjs_Pz(gvjs_Rz(gvjs_Oz(p), gvjs_Oz(r)), function(v) {
            ...
            null == w && n.debug ? g.push(new gvjs_NR(v,
                gvjs_KL(new gvjs_IL("debug"), gvjs_KQ, t++), gvjs_Wo)) : null != w && g.push(new gvjs_NR(v, gvjs_KL(gvjs_LL(w), gvjs_KQ, u++), x))
        });
    ...
    this.xa &&
        a.push(this.cache(gvjs_0Q, function() {
...
gvjs_.bz = function(a, b) {
    ...
    if (b && !this.xa && a.type() === gvjs_HQ) {
        ...
        b instanceof
        gvjs_4Q ? (b = a ? gvjs_$y(gvjs_L(k, gvjs_Xd)) : 0, a = a ? 0 : gvjs_$y(gvjs_L(k, gvjs_4c))) : a = b = 0;
...
gvjs_.nm = function(a, b, c) {
    if (a)
        if (b.type === gvjs_Pd) this.bz(a, c);
            ...
            if (this.hp.size !== d || e === gvjs_IQ) Date.now(), gvjs_Wia(this);
...
function gvjs__S(a) {
    ...
    return gvjs_mj(gvjs_jq(b), {
        ...
        axes: {
            ...
            y: gvjs_mj(gvjs_Ny(b.pb(gvjs_Hx),
                function(c, d) {
...
function gvjs_1S(a, b, c, d, e, f, g) {
    ...
    this.vh = [];
    a = 0;
    for (b = this.sm.length; a < b; a++) this.vh.push(this.scale(this.sm[a].v))
}
gvjs_1S.prototype.draw = function(a, b, c) {
    if (this.Qm) {
        if (null == this.xp) throw Error("startY must be set before calling draw().");
        ...
        if (0 !== d) {
            var e = this.xg[0],
                ...
                h = [];
            this.vh[0] - f / 2 < this.J4 - this.Fz && (e.textAlign = gvjs_2, g[0].start = this.vh[0], g[0].end = this.vh[0] + f);
            e = this.xg[d];
            f = e.La(a);
            var k = new gvjs_O(this.vh[d] - f / 2, this.vh[d] + f / 2);
            f / 2 + this.vh[d] - this.Qva > this.ga + this.J4 && (e.textAlign = gvjs_R, k.start = this.vh[d] - f, k.end = this.vh[d]);
            ...
            f = 0;
            for (k = h.length; f < k; f++) l = this.xg[h[f]], l.label = ""
        }
        a = {};
        d = 0;
        for (g = this.sm.length; d < g; d++)
            if (m = this.xg[d], !(this.Gc > this.sm[d].v) && m.label) {
                ...
                l = m.ja;
                m = m.label.split("\n");
                for (var n = [], p = 0, q = m.length; p < q; p++) n.push(h(m[p], e, f, 15, k, gvjs_2, l)), f += 15;
                h = n;
                e = 0;
                for (f = h.length; e < f; e++) c(h[e], null, a)
            }
        this.Qm = !1
    }
};
...
gvjs_1S.prototype.ria = function(a) {
    ...
    switch (a) {
        case "axisLabelFormatter":
            return function(g, h) {
                c.PC = h;
                if (h <= Dygraph.THIRTY_SECONDLY) return g = b("s", g), f = new gvjs_ly(gvjs_0ia), c.xg.push(new gvjs_0R(g, f)), c.xg.length - 1 + "";
                if (h <= Dygraph.THIRTY_MINUTELY) {
                    var k = ":mm";
                    0 === g.getMinutes() || d ? (h = !0, k = gvjs_Ia) : h = !1;
                    d = !1;
                    g = b(k, g);
                ...
                if (h <= Dygraph.SIX_HOURLY) return k =
                    "h", h = g.getHours(), 0 !== g.getMinutes() && (k += ":m"), h = 12 === h || 0 === h || d, d = c.Gc > g.valueOf() ? !0 : !1, h && (k += "\n a"), g = b(k, g), f = new gvjs_ly(gvjs_2ia), gvjs_jy(f, h), c.xg.push(new gvjs_0R(g, f)), c.xg.length - 1 + "";
                if (h <= Dygraph.DAILY) return k = "E", 0 === g.getDay() || d ? (k += "\n M/d", h = !0) : h = !1, d = !1, g = b(k, g), f = new gvjs_ly(gvjs_3ia), gvjs_jy(f, h), c.xg.push(new gvjs_0R(g, f)), c.xg.length - 1 + "";
                if (h <= Dygraph.WEEKLY) return h = d, d = !1, g = b("MMM d", g), f = new gvjs_ly(gvjs_4ia), gvjs_jy(f, h), c.xg.push(new gvjs_0R(g, f)), c.xg.length - 1 +
                    "";
                if (h <= Dygraph.BIANNUAL) return k = "MMM", h = 0 === g.getMonth() || d, d = c.Gc > g.valueOf() ? !0 : !1, h && (k += "\n yyyy"), g = b(k, g), f = new gvjs_ly(gvjs_5ia), gvjs_jy(f, h), c.xg.push(new gvjs_0R(g, f)), c.xg.length - 1 + "";
                if (h <= Dygraph.CENTENNIAL) return g = b("yyyy", g), f = new gvjs_ly(gvjs_6ia), c.xg.push(new gvjs_0R(g, f)), c.xg.length - 1 + "";
                throw Error(gvjs_OQ);
            };
        case "pixelsPerLabel":
            return 50
...
gvjs_3S.prototype.format = function(a, b) {
    var c = "MMM dd, yyyy",
        d = "MMM dd, yyyy";
    a.getYear() === b.getYear() && (c = "MMM dd", a.getMonth() === b.getMonth() && (d = "dd, yyyy"));
    c = new gvjs_Xi(c);
    d = new gvjs_Xi(d);
...
gvjs_4S.prototype.format = function(a, b) {
    ...
    if (864E5 > Math.abs(b - a)) return [d, c].join(gvjs_ar);
...
gvjs_5S.prototype.format = function(a, b) {
    var c = gvjs_Ia;
    if (0 !== a.getMilliseconds() || 0 !== b.getMilliseconds()) c += ":ss.SSS";
    else if (0 !== a.getSeconds() || 0 !== b.getSeconds()) c += ":ss";
    c = new gvjs_Xi(c);
...
gvjs_5S.prototype.tv = function(a, b) {
    ...
    0 < c && a.push(c + "h");
    0 < d && a.push(d + "m");
    if (e || b) c = e.toString(), 0 < b && (d = b.toString(), 3 <= d.length ? b = d : (b = "000" + b.toString(), b = b.substr(b.length - 3)), c += "." + b), a.push(c + "s");
...
gvjs_6S.prototype.tv = function(a, b) {
    ...
    0 > g && (f--, g += gvjs_Pi(c, (d + 11) % 12));
    0 > f && (e--, f += 12);
    c = [];
    0 < e && (d = gvjs_2S(e, " year"), c.push(e.toString() + d));
    0 < f && (d = gvjs_2S(f, " month"), c.push(f.toString() + d));
    0 < g && (d = gvjs_2S(g, " day"), c.push(g.toString() + d));
...
gvjs_8S.prototype.format = function(a, b) {
    var c = "s";
    if (0 !== a.getMilliseconds() || 0 !== b.getMilliseconds()) c += ".SSS";
    c += "'s'";
    if (a.getSeconds() > b.getSeconds() || 6E4 < b - a) c = "m'm' " + c;
    c = new gvjs_Xi(c);
    return [c.format(a), c.format(b)].join(gvjs_ar)
};
...
function gvjs_7S(a) {
    var b = gvjs_9S[a];
    if (!b) throw Error("Formatter not found for granularity: " + a + ".");
    return new b
};
...
gvjs_aT.prototype.tN = function() {
    ...
    var d = {},
        e;
    for (e in c) c[e].columns.forEach(function(m) {
        d[m] = {
            name: e,
            axis: c[e]
        }
    ...
    var f = {};
    for (e in b) b[e].columns.forEach(function(m) {
        f[m] = {
            name: e,
            axis: b[e]
        }
