(function() {
    ...
    */
    ...
    q("Promise", function(a) {
        ...
        b.all = function(f) {
            ...
            return k.done ? d([]) : new b(function(m, n) {
                ...
                var x = [],
                    H = 0;
                do x.push(void 0), H++, d(k.value).F(v(x.length - 1), n), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    function Xa(a) {
        a: {
            ...
            if (b.querySelector && (b = b.querySelector("script[nonce]")) && (b = b.nonce || b.getAttribute("nonce")) && Ya.test(b)) break a;b = ""
        }
    ...
    function Cb() {
        if (A.Promise && A.Promise.resolve) {
            ...
            var b = Eb;
            "function" !== typeof A.setImmediate || A.Window && A.Window.prototype && !P("Edge") && A.Window.prototype.setImmediate == A.setImmediate ? (sb || (sb = tb()), sb(b)) : A.setImmediate(b)
        }
    }
    var Db = !1,
        yb = new vb;
        ...
        if (0 == a.g)
            if (a.i) {
                ...
                if (c.h) {
                    ...
                    e && (0 == c.g && 1 == d ? Kb(c, b) : (g ? (d = g, d.next == c.j && (c.j = d), d.next = d.next.next) : Lb(c), Mb(c, e, 3, b)))
                }
                a.i = null
            } else R(a, 3, b)
    }
    ...
    function R(a, b, c) {
        if (0 == a.g) {
            ...
            f || (a.u = c, a.g = b, a.i = null, Ob(a), 3 != b || c instanceof S || Qb(a, c))
        }
    }
    ...
    */
    ...
    function Tb(a) {
        ...
        for (var d = c = !1; a.l.length && !a.u;) {
            ...
            if (g = a.j ? f : g) try {
                ...
                if (Fb(b) || "function" === typeof A.Promise && b instanceof A.Promise) d = !0, a.u = !0
            } catch (k) {
                b = k, a.j = !0, Wb(a) || (c = !0)
            }
        }
        a.h = b;
        d && (h = C(a.B, a, !0), d = C(a.B, a, !1), b instanceof T ? (Vb(b, h, d), b.G = !0) : b.then(h, d));
        c && (b =
            new Yb(b), Xb[b.g] = b, a.o = b.g)
    }
    ...
    function cc(a, b) {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (ec(e, c.X || !1, h), V(f), W(f, !0, null))
        };
        e.onerror = function() {
            ec(e, !0, h);
            var m = new fc(0, "Error while loading script " +
                d);
            V(f);
            W(f, !1, m)
        };
    ...
    */
    ...
    function uc(a) {
        ...
        var b = a.N,
            ...
            d = Fa(K(c, function(g) {
                ...
                Ca[g] ? (g = Ca[g], Object.assign(f, g), g = Z[g.subdir ? "third_party" : "third_party2"]) : Da[g] ? (Object.assign(f, Da[g]), g = Z.third_party_gen) : g = Z[(qc ? "debug" : rc ? "pseudo" : "compiled") + (pc ? "_i18n" : "")];
                return g ? {
                    format: g,
                    H: f,
                    M: void 0
    ...
    D("google.charts.loader.VersionSpecific.setOnLoadCallback", function(a) {
        if (!xc) throw Error("Must call google.charts.load before google.charts.setOnLoadCallback");
        if (!a) return xc;
